...
/**************************************TEMA 19 Atributo default en una columna de una tabla********************/
...
insert into libros (titulo,autor,editorial,precio,cantidad)
  values('Java en 10 minutos','Juan Pereyra','Paldos',25.7,100);
...
insert into libros (titulo,autor,precio,cantidad)
  values('Aprende Php','Alberto Lopez',55.40,150);

-- Se guarda un valor por defecto "Desconocido" en el campo autor  
